...
Welcome to Soft Pas ("the App"), a mobile application developed by Vitalii Ivashchenko ("we," "us," or "our"). By downloading, accessing, or using the App, you agree to be bound by these Terms of Use ("Terms"). If you do not agree to these Terms, please do not use the App.

## 1. Acceptance of Terms
By downloading, installing, or using the App, you agree to comply with these Terms of Use. If you do not agree, please do not use the App.

## 2. License to Use
We grant you a non-exclusive, non-transferable, limited license to use the App for personal, non-commercial purposes.
You may not:
...
As we use third-party services, we have no control over these services. This includes, but is not limited to, analytics, and other external platforms used within the App. We are not responsible for any issues, outages, or inaccuracies that may occur as a result of third-party service dependencies.

## 7. In-App Purchases

Soft Paws offers optional In-App Purchases to unlock additional game modes and enhance your experience.

By making an In-App Purchase, you agree to the following terms:
- Billing and Payment
    - In-App Purchases are processed through Apple's payment system and charged to your Apple ID account.
    - Prices may vary by region and are displayed at the time of purchase.
    - Payment will be charged upon confirmation of purchase.
- Non-Refundable
    - All purchases are final and non-refundable, except where required by law or at Apple’s discretion.
    - For refund requests, please contact Apple Support directly.
- Access to Purchased Content
    - Purchased game modes will be unlocked and available as part of the App once the transaction is successful.
    - If you delete and reinstall the App, you can restore your purchases by using the Restore Purchases option in the App.
- User Responsibility
    - Ensure that you have proper authorization for purchases, especially when the device is shared with others (e.g., children).
    - In-App Purchases are tied to your Apple ID and may not be transferable across devices or accounts.
